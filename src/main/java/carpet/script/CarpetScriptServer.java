...
public class CarpetScriptServer
{
    ...
    public void addEvents(CommandSource source, String hostName)
    {
    ...
    public void addCommand(CommandSource source, String hostName)
    {
        ScriptHost host = modules.get(hostName);
        if (host == null)
        {
    ...
    public boolean removeScriptHost(CommandSource source, String name)
    {
        name = name.toLowerCase(Locale.ROOT);
        if (!modules.containsKey(name))
        {
    ...
    public boolean runas(CommandSource source, String hostname, String udf_name, List<LazyValue> argv)
    {
        return runas(BlockPos.ORIGIN, source, hostname, udf_name, argv);
    }

    public boolean runas(BlockPos origin, CommandSource source, String hostname, String udf_name, List<LazyValue> argv)
    {
