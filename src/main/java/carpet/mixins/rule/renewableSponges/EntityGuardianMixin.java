package carpet.mixins.rule.renewableSponges;
...
public abstract class EntityGuardianMixin extends EntityMob {
    ...
    public void onStruckByLightning(EntityLightningBolt lightningBolt) {
        if (!this.world.isRemote && !this.removed && CarpetSettings.renewableSponges) {
            ...
            elderGuardian.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(elderGuardian)), null, null);
